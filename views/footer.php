...
<footer class="footer">
    <div class="footer-stanga">
        <h1>
            <img id="logo" src="public/poze/logo.png" alt="logo" />
    ...
    <div class="footer-centru">
        <div class="locatie">
            <a title="Locatie"><img src="public/poze/locatie-tw.png" alt="locatie" /></a>
            <p>Strada General Henri Mathias Berthelot Nr. 16</p>
        </div>

        <div class="telefon">
            <a title="Telefon"><img src="public/poze/telefon-tw.png" alt="telefon" /></a>
            <p>+4 0767-437-025</p>
        </div>

        <div class="mail">
            <a href="mailto:Impressed2020@company.com?Subject=Impressed" title="Mail"><img src="public/poze/mail-tw.png" alt="mail" /></a>
