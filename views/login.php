...
<body>
  ...
  <main>
    <div class="main-stanga">
      ...
      <button class="buton-stanga" type="button" onclick="window.location.href='./home.php'">
        Logare
      </button>
    </div>
    <hr />
    <div class="main-dreapta">
      ...
      <button class="buton-dreapta" type="button" onclick="window.location.href='./signIn.php'">
