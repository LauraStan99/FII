    ...
    <article resource="#" typeof="schema:ScholarlyArticle">
        ...
        <div class="cuprins">
            ...
            <ol>
                ...
                <li><a href="#server-web">Server Web</a>
                    <ol>
                        <li><a href="#htaccess">.htaccess</a></li>
                        <li><a href="#index">index.php</a></li>
                        <li><a href="#bootstrap">Clasa Bootstrap</a></li>
                    </ol>
                </li>
                <li><a href="#structura-MVC">Arhitectura MVC a aplicatiei</a>
                    <ol>
                        <li><a href="#structura">Structura claselor Controller-View-Model + Database</a></li>
                        <li><a href="#diagrama-controller">Diagrama Interfetei Controller</a></li>
                        <li><a href="#diagrama-model">Diagrama Interfetei Model</a></li>
                    </ol>
                </li>
        ...
        <section typeof="sa:Abstract" id="abstract" role="doc-abstract">
            ...
            <p> Aceste 3 categorii de utilizatori au in comun vizualizarea produselor site-ului, filtrarea si ordonarea acestora,
                ...
                De asemenea, acestia au acces la toate functionalitatile existente in footer (contact, detalii livrare si servicii, social-media, date de contact).
            </p>
            <p>Atat administratorii, cat si utilizatorii obisnuiti pot realiza comenzi pe aplicatia noastra si avea o pagina de wishlist.</p>
            <p>Utilizatorul obisnuit are posibilitatea de a-si actualiza datele contului personal, de a vizualiza istoricul comenzilor, in detaliu, precum si de a se
                deconecta de pe aplicatie.
            </p>
        ...
        <section id="server-web">
            ...
            <section id="htaccess">
                ...
                <p>Regulile "RewriteCond" trateaza cazurile in care fisierele/directoarele nu exista. Daca acestea nu exista utilizatorul
                    ...
                    va redirectiona catre index.php care realizeaza toata logica aplicatiei.
                </p>
            </section>
            <section id="index">
                ...
                <p>Fisierul index.php este cel care are controlul asupra aplicatiei, deoarece incarca toate librariile aplicatiei,
                    pentru a putea fi utilizate de catre orice fisier al proiectului.
                </p>
            ...
            <section id="bootstrap">
                ...
                <p>Clasa Bootstrap preia URL-ul de la browser. Dupa preluarea URL-ului, daca acesta este gol, este incarcata automat pagina home, prin apelarea functiei index din
        ...
        <section id="structura-MVC">
            ...
            <section id="structura">
                ...
                <p>Clasa Controller (din libs) este extinsa de catre toate clasele din folderul controllers al proiectului.
                ...
                <p>Clasa Database - contine toate functiile CRUD necesare in lucrul cu baza de date, pe care le folosesc fisierele din folderul models.</p>
            </section>
            <section id="diagrama-controller">
            ...
            <p>
                ...
                <ol>
                    <li>Partea de logare a unui utilizator, avand un cont activ
                        ...
                        <p>In momentul in care utilizatorul se deconecteaza de la aplicatie, sesiunea este distrusa odata cu ea si datele retinute despre utilizator.</p>
                    </li>
                    <li>Partea de inregistrare a unui utilizator, creand un nou cont
                        ...
                        <p>Toate aceste date sunt trecute printr-un validator(clasa Validate din folderul /libs care contine toate functiile de validare ale aplicatiei).</p>
                        <ul>
                            ...
                            <li>parola trebuie sa contina obligatoriu cate una din :literamica, litera mare, numere si caractere speciale ( !, @, #, $, %, &, * ) </li>
                        </ul>
                        ...
                        <p>Chiar daca utilizatorul introduce o parola corecta conform cerintelor, dupa codificare, aceasta v-a fi criptata sub o noua forma(256 caractere).
                        </p>
                    </li>
                </ol>
            </p>
        ...
        <section id="flux-RSS">
            ...
            <p>
                La fiecare randare a paginii principale, se face o actalizare a fisierului XML ce trebuie sa contina cele mai populare 10 produse din toata aplicatia,
                aceasta popularitate rezultand din numarul de accesari al fiecarui produs de catre utilizatorii aplicatiei .
            </p>
            <p>XML-ul rezultat este parcurs folosind XPATH si astfel, oferind utilizatorilor posibilitatea de a vizualiza clasamentul produselor
                si in alt format, si anume, ca flux de date RSS.
            </p>
        </section>
        <section id="email">
            <h2>
            ...
            <p>In aplicatia noastra, exista 2 cazuri in care se trimite un email. </p>
            <ol>
            ...
            <p>
                S-au folosit clasele: Exception, OAuth, PHPMailer, POP3 si SMTP. Au fost importate in index.php si s-a creat o instanta a clasei PHPMailer unde a fost nevoie.
                Se foloseste protocolul SMTP cu hostul gmail.com. Apoi, setez adresa de la care se va trimite email-ul si anume impressed.shop@gmail.com . Adaug adresa careia
                i se va trimite mailul, adaug subiectul si body-ul mail-ului si apelez metoda send() pentru a trimite mail-ul cu succes.
            </p>
        </section>
            ...
            <ol>
                ...
                <li>PDF
                    <p>In mometul in care este actionat butonul de exportAsPDF (buton cu id-ul "save-pdf" ) este apelata functia din fisierul de javascript
                        "statisticaPDF", care in momentul cand s-a apasat butonul, se creeaza un obiect de tipul jsPDF() care retine chart-ul drept o imagine,
