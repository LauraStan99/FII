...
<head>
  ...
  <link href="<?php echo URL; ?>public/css/payment1.css" rel="stylesheet" />
</head>
...
<body>
  ...
  <main>
    ...
    <form method="POST">
      ...
      <button type="submit" name="submit" value="submit" class="plaseaza-comanda" onclick="window.location.href='<?php echo URL; ?>confirmationOrder'">
        Finalizare comanda
      </button>
