...
<html lang="en">
  <head>
        <meta charset="utf-8">
        <meta name="description" content="RealHome - Ghid de utilizare">
        <meta name="keywords" content="HTML,CSS,JS,PHP,project,infoiasi,web">
        <meta name="author" content="Apostu Razvan Gabriel, Mocanu Alexandru">
  ...
  <body>
    ...
    <p>
        Realhome este o aplicatie web care ofera un mediu securizat si intuitiv in care utilizatorii pot cauta informatii despre locuintele puse la vanzare in diferite zone.
        Utilizatorul poate cauta proprietati in functie de mai multe filtre.
        Proprietatile sunt afisate pe o harta interactiva, cu mai multe straturi de date afisate.
        Utilizatorul poate crea un cont, in care poate salva proprietatile preferate.
    </p>
    </section>
    ...
    <section id="app-guide" role="doc-app-guide">
            ...
            <p>
                In continuare va fi descris modul in care utilizatorul interactioneaza cu aplicatia.
            </p>
            <section id="navbar">
                <h3>
                    <span>2.1 </span>
                ...
                <p>
                    In fiecare pagina a aplicatii este prezenta bara de navigare, care contine un camp in care utilizatorul poate introduce
                    cuvinte cheie care vor fi folosite la cautare.
                </p>
                <p>
                    Bara de navigare contine si cate un buton care trimite la celelalte pagini ale aplicatiei: home, buy, rent, user profile si listing profile.
                </p>
            </section>
            <section id="home">
                <h3>
