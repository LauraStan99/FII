            ...
            class Produse extends Controller
            {
                ...
                public function copii($category)
                {
                    ...
                    if (isset($_POST['aplica-filtre'])) {
                      ...
                      //  header('location: ' . URL . 'produse/copii/' . $category . '?marime=' . $marime . '&culoare=' . $culoare . '&material=' . $material . '&tip=' . $tip . '&pret1=' . $pret1 . '&pret2=' . $pret2);
                    } else {
                ...
                public function copiiOrder($category, $order, $filter)
                {
                    ...
                    if ($_GET['marime']) {
                        if ($_GET['marime'] == 'false') {
                            $resultPage = $product->selectByFilterWithoutSize("'" . $category . "'", $_GET['material'], $_GET['tip'], "'copii'", $_GET['culoare'], $_GET['pret1'] . " and " . $_GET['pret2'], $this->view->count);
                        } else {
                            $resultPage = $product->selectByFilter("'" . $category . "'", $_GET['material'], $_GET['marime'],  $_GET['tip'], "'copii'", $_GET['culoare'], $_GET['pret1'] . " and " . $_GET['pret2'], $this->view->count);
                        }
                    }
