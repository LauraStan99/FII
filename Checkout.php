...
$numeErr=$prenumeErr=$adresaErr=$emailErr=$orasErr=$taraErr="";
$nume=$prenume=$adresa=$email=$oras=$tara="";

if ($_SERVER["REQUEST_METHOD"] == "POST")
 {
  if (empty($_POST["nume-intreg"])) {
    $numeErr = "Numele este obligatoriu";
  } else {
    $nume = test_input($_POST["nume-intreg"]);
    ...
    if (empty($_POST["prenume-intreg"])) {
      $prenumeErr = "Prenumele este obligatoriu";
    } else {
      $prenume = test_input($_POST["prenume-intreg"]);
  ...
  if (empty($_POST["email-Checkout"])) {
    $emailErr = "Email-ul este obligatoriu";
  } else {
    $email = test_input($_POST["email-Checkout"]);
  ...
  if (empty($_POST["adresa-Checkout"])) {
    $adresaErr = "Adresa este obligatorie";
  } else {
    $adresa = test_input($_POST["adresa-Checkout"]);
  }

  if (empty($_POST["oras-Checkout"])) {
    $orasErr = "Orasul este obligatoriu";
  } else {
    $oras= test_input($_POST["oras-Checkout"]);
    ...
    if (empty($_POST["tara-Checkout"])) {
    $taraErr = "Tara este obligatorie";
  } else {
    $tara = test_input($_POST["tara-Checkout"]);
      ...
      <div class="main-stanga">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">  
                ...
                <div class="input">
                    ...
                    placeholder="Iasi"
                    />
                    <span class="error" style="color:red">*  <?php echo $orasErr ;?></span>
                </div>
                ...
                <div class="input">
                    ...
                    placeholder="Romania"
                    />
                    <span class="error" style="color:red">*  <?php echo $taraErr ;?></span>
                </div>    
         </form>   
        <button
          id="inapoi-la-cos"
